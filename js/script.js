/*! Bundled dependencies: GSAP, ScrollTrigger, CustomEase + App logic */
...
! function(e, t) {
    ...
    function stringToRawPath(e) {
        ...
        var t, n, s, a, r, i, o, h, u, c, f, l, g, x, d, m = (e + "").replace(w, function(e) {
                var t = +e;
        ...
        for (t = 0; t < v; t++)
        ...
        else if ("S" === r) c = y, f = M, "C" !== g && "S" !== g || (c += y - o[o.length - 4], f += M - o[o.length - 3]), i || (y = M = 0), o.push(c, f, s, a, y += 1 * m[t + 3], M += 1 * m[t + 4]), t += 4;
        else if ("Q" === r) c = y + 2 / 3 * (s - y), f = M + 2 / 3 * (a - M), i || (y = M = 0), y += 1 * m[t + 3], M += 1 * m[t + 4], o.push(c, f, y + 2 / 3 * (s - y), M + 2 / 3 * (a - M), y, M), t += 4;
        else if ("T" === r) c = y - o[o.length - 4], f = M - o[o.length - 3], o.push(y + c, M + f, s + 2 / 3 * (y + 1.5 * c - s), a + 2 / 3 * (M + 1.5 * f - a), y = s, M = a), t += 2;
            ...
            if (x = m[t + 4], d = m[t + 5], c = m[t + 6], f = m[t + 7], n = 7, 1 < x.length && (x.length < 3 ? (f = c, c = d, n--) : (f = d, c = x.substr(2), n -= 2), d = x.charAt(1), x = x.charAt(0)), l = arcToSegment(y, M, +m[t + 1], +m[t + 2], +m[t + 3], +x, +d, (i ? y : 0) + 1 * c, (i ? M : 0) + 1 * f), t += n, l)
    ...
    function x(e, t, n, s, a, r, i, o, h, u, c) {
        var f, l = (e + n) / 2,
            g = (t + s) / 2,
            d = (n + a) / 2,
            m = (s + r) / 2,
        ...
        return u || (u = [{
            ...
            x: b,
            y: w
        }), h * (P * P + S * S) < (N + D) * (N + D) && (f = u.length, x(e, t, l, g, M, v, b, w, h, u, c), x(b, w, C, E, p, y, i, o, h, u, c + 1 + (u.length - f))), u
    }
    var M, a, t, y = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/gi,
        v = /[cLlsSaAhHvVtTqQ]/g,
        n = ((t = CustomEase.prototype).setData = function setData(e, t) {
            t = t || {};
            var n, s, a, r, i, o, h, u, c, f = (e = e || "0,0,1,1").match(y),
                l = 1,
                g = [],
                d = [],
                m = t.precision || 1,
                p = m <= 1;
            if (this.data = e, (v.test(e) || ~e.indexOf("M") && e.indexOf("C") < 0) && (f = stringToRawPath(e)[0]), 4 === (n = f.length)) f.unshift(0, 0), f.push(1, 1), n = 8;
            else if ((n - 2) % 6) throw "Invalid CustomEase";
            for (0 == +f[0] && 1 == +f[n - 2] || function _normalize(e, t, n) {
                ...
                }(f, t.height, t.originY), this.segment = f, r = 2; r < n; r += 6) s = {
                x: +f[r - 2],
                y: +f[r - 1]
            }, a = {
                x: +f[r + 4],
                y: +f[r + 5]
            }, g.push(s, a), x(s.x, s.y, +f[r], +f[r + 1], +f[r + 2], +f[r + 3], a.x, a.y, 1 / (2e5 * m), g, g.length - 1);
            ...
            if (i = 1 / (n = 1 / l + 1 | 0), h = g[o = 0], p) {
                for (r = 0; r < n; r++) c = r * i, h.nx < c && (h = g[++o]), s = h.y + (c - h.x) / h.cx * h.cy, d[r] = {
                    x: c,
                    cx: i,
                    y: s,
                    cy: 0,
                ...
                o = g[g.length - 1], d[n - 1].cy = o.y - s, d[n - 1].cx = o.x - d[d.length - 1].x
            } else {
            ...
            var n, a, r, i, o, h, u, c, f, l, g = (t = t || {}).width || 100,
                x = t.height || 100,
                d = t.x || 0,
                p = (t.y || 0) + x,
            ...
            if (t.invert && (x = -x, p = 0), "string" == typeof e && (e = M.parseEase(e)), e.custom && (e = e.custom), e instanceof CustomEase) n = function rawPathToString(e) {
                ...
                for (var o, h, u, c, f, l = e.length; - 1 < --l;)
                    for (h = (o = e[l]).length, u = 0; u < h; u += 2) c = o[u], f = o[u + 1], o[u] = c * t + f * s + r, o[u + 1] = c * n + f * a + i;
                return e._dirty = 1, e
            }([e.segment], g, 0, 0, -x, d, p));
            else {
                for (n = [d, p], i = 1 / (u = Math.max(5, 200 * (t.precision || 1))), c = 5 / (u += 2), f = s(d + i * g), a = ((l = s(p + e(i) * -x)) - p) / (f - d), r = 2; r < u; r++) o = s(d + r * i * g), h = s(p + e(r * i) * -x), (Math.abs((h - l) / (o - f) - a) > c || r === u - 1) && (n.push(f, l), a = (h - l) / (o - f)), f = o, l = h;
                n = "M" + n.join(",")
            }
    ...
    n.version = "3.13.0", n.headless = !0, p() && M.registerPlugin(n), e.CustomEase = n, e.default = n;
    if (typeof(window) === "undefined" || window !== e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        })
